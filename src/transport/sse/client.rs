...
//!
//! Client-side Server-Sent Events connection handling
...
/// Server-Sent Events client connection implementation
...
mod tests {
    ...
    async fn test_sse_client_creation() {
        ...
        let client = SseClient::new(config).await;
        assert!(client.is_ok());
    }
    ...
    fn test_sse_event_parsing() {
        ...
        let event = SseClient::parse_sse_event_static(event_data).unwrap();
